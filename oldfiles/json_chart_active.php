...
//$array_reducido_ordenado=array();
foreach ($array_reducido as $dato) {
	$total=$dato['total'];
	$idemp=$dato['emp'];
	//array_multisort($volumen, SORT_DESC, $edición, SORT_ASC, $datos);

	//array_push($array_reducido_ordenado, $ordena);
}

array_multisort($total,SORT_DESC, $idemp, SORT_ASC, $array_reducido);
